...
if __name__ == "__main__":
    ...
    while True:
        ...
        if opcion == "1":
            ...
            incluir_patrones = input(
                "¿Incluir búsqueda por patrón sospechoso (más lenta, más cobertura)? (s/n): "
            ).strip().lower() == "s"
            monitor = MonitorCertificados()
            dominios = monitor.escanear_todo(incluir_patrones=incluir_patrones)
